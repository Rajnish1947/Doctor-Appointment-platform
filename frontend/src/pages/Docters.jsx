...
const Docters = () => {
  ...
  // that is for mobile view filter
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        >
          <p
            ...
            className={`w-[44vw]  sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${
              speciality === "General physician"
        ...
        <div className="w-full grid grid-cols-auto gap-4 gap-y-6">
          {filterDoc.map((item) => (
            <div
              ...
              className="border border-blue-200 rounded-xl overflow-hidden cursor hover:translate-y-[-10px] transition-all duration-500 "
              key={item._id}
            >
